...
Abbiamo allenato 3 diversi algoritmi sul nostro training data con il sentiment manuale. 
Bayes, Random Forest e Support Vector Machine. Questo è un sample del loro risultato. In seguito analizzeremo piu' a fondo le loro performances attraverso il processo di cross validation.
...
```
Wow! Che sta succedendo qui? I nostri algoritmi stanno dando valutazioni completamente diverse!
...
Ci risulta l`utilizzo di 173 support vectors.
L`accuracy del support Vector Machine si posiziona tra Bayes e Random Forest.
